...
class MAIN:
	def __init__(self):
		self.snake = SNAKE()
		self.fruit = FRUIT()
		self.theme_song = pygame.mixer.Sound('Snake Game/Sound/Super Mario Bros. medley.mp3')
	...
	def play_theme_song(self):
			...
			self.theme_song.set_volume(0.2)
...
apple = pygame.image.load('Snake Game/Graphics/apple.png').convert_alpha()
game_font = pygame.font.Font('Snake Game/Font/ARCADECLASSIC.ttf', 25)

SCREEN_UPDATE = pygame.USEREVENT
pygame.time.set_timer(SCREEN_UPDATE,150)

main_game = MAIN()
main_game.play_theme_song()
